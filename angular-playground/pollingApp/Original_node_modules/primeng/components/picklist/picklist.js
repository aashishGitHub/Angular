...
var PickList = /** @class */ (function () {
    ...
    PickList.prototype.onKeyDown = function (event) {
        var opts = [];
        var listType;
    ...
    PickList.prototype.indexWithDisplay = function (element) {
        var children = element.parentNode.childNodes;
        var num = 0;
        for (var i = 0; i < children.length; i++) {
            if (children[i] == element && children[i].style.display == 'block' && this.domHandler.hasClass(children[i], 'ui-picklist-item'))
                return num;
            if (children[i].nodeType == 1 && children[i].style.display == 'block' && this.domHandler.hasClass(children[i], 'ui-picklist-item'))
                num++;
        }
        return -1;
    };
    PickList.prototype.findPrevOption = function (row) {
    ...
    PickList.prototype.findNextOption = function (row) {
    ...
    ], PickList.prototype, "onKeyDown", null);
    PickList = __decorate([
        core_1.Component({
            selector: 'p-pickList',
