...
var ContextMenuSub = /** @class */ (function () {
    ...
    ContextMenuSub.prototype.position = function (sublist, item) {
        ...
        var itemOuterHeight = this.domHandler.getOuterHeight(item.children[0]);
        var sublistHeight = sublist.offsetHeight ? sublist.offsetHeight : this.domHandler.getHiddenElementOuterHeight(sublist);
